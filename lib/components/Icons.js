...
var Glyph = function Glyph(_ref) {
  ...
  switch (glyph) {
    ...
    case 'blockquote':
      return _react.default.createElement("g", null, _react.default.createElement("path", {
        d: "M12.35,5l-1.6,1.73L19.34,16l-8.59,9.25L12.35,27,22.52,16Z"
      }));
    ...
    case 'colorize':
      return _react.default.createElement("g", null, _react.default.createElement("path", {
        d: "M25.84,8.68,23.2,6a1.12,1.12,0,0,0-1.6,0L18.07,9.58,15.9,7.38,14.3,9l1.61,1.64L5.83,20.88v5.47H11.2L21.28,16.09l1.6,1.63,1.6-1.62-2.17-2.21,3.53-3.59A1.16,1.16,0,0,0,25.84,8.68ZM10.26,24.05,8.09,21.84l9.11-9.27,2.17,2.2Z"
      }));
  }
};
