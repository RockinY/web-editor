...
var Glyph = function Glyph(_ref) {
  ...
  switch (glyph) {
    ...
    case 'code':
      return _react.default.createElement("g", null, _react.default.createElement("path", {
        d: "M12,22a1.1,1.1,0,0,1-.78-.31L6.1,16.76a1,1,0,0,1,0-1.48h0l5.1-4.93a1.12,1.12,0,0,1,1.54-.08,1,1,0,0,1,.09,1.49l-.08.08L8.41,16l4.33,4.18a1,1,0,0,1,0,1.49A1.06,1.06,0,0,1,12,22Zm8,0a1.1,1.1,0,0,0,.81-.31l5.1-4.93a1,1,0,0,0,0-1.48h0l-5.1-4.93a1.13,1.13,0,0,0-1.56,0,1,1,0,0,0,0,1.51L23.56,16,19.22,20.2a1,1,0,0,0,0,1.49A1.11,1.11,0,0,0,20,22Z"
      }));
