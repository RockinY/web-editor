...
var _default = function _default() {
  ...
  var _config$structure = config.structure,
      structure = _config$structure === void 0 ? [_button.BoldButton, _button.UnderlineButton, _button.BlockquoteButton, _button.TextColorButton, _button.LinkButton] : _config$structure;
  var toolbarProps = {
    store: store,
    structure: structure,
