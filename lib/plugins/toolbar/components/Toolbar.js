...
function (_Component) {
  ...
  function Toolbar() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onVisibilityChanged", function (isVisible) {
      var toolbarHeightOffset = 42;
      var selectionRect = isVisible ? (0, _draftJs.getVisibleSelectionRect)(window) : undefined;
      var editorNode = document.getElementsByClassName("draftjs-web-editor")[0];
      var ecitorPosition = editorNode.getBoundingClientRect();
      if (selectionRect === undefined || selectionRect === null) return;
      var top = selectionRect.top === undefined ? 0 : selectionRect.top - ecitorPosition.top - toolbarHeightOffset;
      var left = selectionRect.left === undefined ? 0 : selectionRect.left - ecitorPosition.left + selectionRect.width / 2;
      var position = {
        top: top,
        left: left
      };
  ...
  _createClass(Toolbar, [{
    ...
    value: function render() {
      ...
      if (!editorState.getSelection().getHasFocus() || editorState.getSelection().isCollapsed() || _draftJs.RichUtils.getCurrentBlockType(editorState) === 'code-block') {
        show = false;
      }

      return _react.default.createElement(_OutsideClickHandler.default, {
        onOutsideClick: this.closeModal
      }, _react.default.createElement(_styles.ToolbarWrapper, {
        show: show,
        style: position
