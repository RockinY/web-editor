...
function (_Component) {
  ...
  function Toolbar() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "outsideClick", function () {
  ...
  _createClass(Toolbar, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_OutsideClickHandler.default, {
