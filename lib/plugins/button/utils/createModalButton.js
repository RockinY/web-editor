  ...
  return (
    ...
    function (_Component) {
      ...
      function embedButton() {
        ...
        _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(embedButton)).call.apply(_getPrototypeOf2, [this].concat(args)));

        _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onClick", function (e) {
          e.preventDefault();

          _this.props.openModal(type);
        });
