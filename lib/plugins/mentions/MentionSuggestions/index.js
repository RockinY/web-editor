...
var _styles = require("./Entry/styles");
...
function (_Component) {
  ...
  function MentionSuggestions() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onEditorStateChange", function (editorState) {
      ...
      var anchorOffset = selection.getAnchorOffset(); // the list should not be visible if a range is selected

      if (!selection.isCollapsed()) return removeList(); // identify the start & end positon of each search-text
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onSearchChange", function (editorState, selection, activeOffsetKey, lastActiveOffsetKey) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDownArrow", function (keyboardEvent) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onTab", function (keyboardEvent) {
      keyboardEvent.preventDefault();

      _this.commitSelection();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onUpArrow", function (keyboardEvent) {
      keyboardEvent.preventDefault();
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onEscape", function (keyboardEvent) {
      keyboardEvent.preventDefault();
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onMentionSelect", function (mention) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onMentionFocus", function (index) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "commitSelection", function () {
  ...
  _createClass(MentionSuggestions, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement(_styles.SuggestionWrapper, {
        role: "listbox",
